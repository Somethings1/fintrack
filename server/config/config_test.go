...
func TestConfigurationFailsClosed(t *testing.T) {
	base := map[string]string{"APP_ENV": "production", "LEDGER_CURRENCY": "USD", "MONGO_URI": "mongodb://db/", "SUPABASE_URL": "https://test.supabase.co", "SUPABASE_ANON_KEY": "public-test-key", "ALLOWED_ORIGINS": "https://finance.example"}
