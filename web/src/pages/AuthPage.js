...
import { Box, Button, Input, Heading, Text, Tabs, Fieldset } from "@chakra-ui/react";
import { useNavigate } from "react-router-dom";
import { Field } from "../components/ui/field"
import { fetchTransactionsToDB, fetchAccountsToDB, fetchCategoriesToDB } from "../util/db";
...
const LogInForm = ({ onLogin }) => {
    ...
    const fetchData = async () => {
        await fetchTransactionsToDB(new Date().getFullYear());
        await fetchAccountsToDB();
        await fetchCategoriesToDB();
    }
